...
<h3>Reservas confirmadas pendientes de pago</h3>

<?php
            $query = mysqli_query($conexion,"SELECT datosreserva.*,estados.estado from datosreserva,estados WHERE datosreserva.estado = estados.idEstado AND estados.estado = 'confirmada'");
...
<table class="table table-bordered table-light">
		...
		while ($row = mysqli_fetch_array($query))
		{
			...
			echo '<tr class="table-danger">
					...
					<td><form>
					<input type="hidden" value="'.$row['idReserva'].'" class="idReserva">
    ...
    $(".pagar").click(function(){
		...
		$.ajax({
			...
			success: function(){
				...
				location.href ="reservasConfirmadas.php";
			}
